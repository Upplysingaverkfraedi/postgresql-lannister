...
- Svo er notuð reglulega segðin ´regexp_matches(c.born, '(\d+) (AC|BC)') AS born´til að finna fæðingarár úr ´born´ dálknum. Reglulega segðin finnur því tölustafinn og AC eða BC, en útilokar annan texta eins og 'Between eða In Pyre'. 
